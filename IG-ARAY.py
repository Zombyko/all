...
#----------[USER AGENT V2]---------#
    def UserAgent():
        ...
        ua1 = f'Instagram {versi} Android ({andro}; {dpis}; {pxl}; INFINIX MOBILITY LIMITED/Infinix; Infinix X657B; Infinix-X657B; mt6761; {basa}; {kode})'
        ...
        ua5 = f'Instagram {versi} Android ({andro}; {dpis}; {pxl}; HMD Global/Nokia; Nokia 2.4; WVR_sprout; mt6762; {basa}; {kode})'
